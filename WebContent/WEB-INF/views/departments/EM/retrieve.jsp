        ...
        <table style="border-spacing: 20px; border-top:0px; border-collapse: separate;">
            <tr>
            	...
            	<td>
            		...
            		<emForm:input style="width: 230px; height: 35px;" id="contractorName" path="contractorName" list="contractorNameHelp" onkeyup="getHelp('contractorName');"/>
            		<datalist id="contractorNameHelp"></datalist>
            	</td>
                <td>
                	<label style="font-family: cambria;" for="Work Name"><h4><b>Work Name:</b></h4></label><br>
                	<emForm:input style="width: 230px; height: 35px;" id="workName" path="workName" list="workHelp" onkeyup="getHelp('workName');"/>
            ...
            <tr>
				<td>
                	...
                	<emForm:input style="width: 230px; height: 35px;" path="year" id="year" list="yearHelp" onkeyup="getHelp('year');"/>
...
<c:if test="${not empty records}">
	<form action="generateReport" id="reportForm" method="post">
		<input type="hidden" name="department" value="EM">
